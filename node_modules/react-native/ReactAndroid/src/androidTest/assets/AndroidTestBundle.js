...
require(32 /* NativeModules */),SourceCode=_require.SourceCode;var _require2=
require(183 /* fetch */),fetch=_require2.fetch;
...
new Error('Bundle was not loaded from the packager'));case 3:
...
}_context.next=7;return regeneratorRuntime.awrap(

fetch(devServer.url+'symbolicate',{
method:'POST',
body:JSON.stringify({stack:stackCopy})}));case 7:response=_context.sent;_context.next=10;return regeneratorRuntime.awrap(

response.json());case 10:json=_context.sent;return _context.abrupt('return',
json.stack);case 12:case'end':return _context.stop();}}},null,this);}
...
}, 203, null, "_shouldPolyfillES6Collection");
